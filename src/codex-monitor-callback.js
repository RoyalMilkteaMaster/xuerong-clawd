...
function isCodexMonitorUserInputEvent(state) {
  return state === "codex-user-input";
}
...
function buildCodexMonitorUpdateOptions(extra, options = {}) {
  ...
  if (Object.prototype.hasOwnProperty.call(input, "userInputRequest")) {
    out.userInputRequest = input.userInputRequest;
  }
