...
const { normalizeCodexUserInputRequest } = require("../agents/codex-user-input");
...
function updateSession(sessionId, state, event, opts = {}) {
  ...
  const srcUserInputRequest = Object.prototype.hasOwnProperty.call(opts, "userInputRequest")
    ? normalizeCodexUserInputRequest(userInputRequest)
    : (existing && existing.userInputRequest) || null;
